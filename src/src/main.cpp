...
#include "../include/cinConnector.hpp"
#include "../include/peerServer.hpp"
#include "../include/identity.hpp"

#include "../include/handleKeyParam.hpp"
#include "../include/confFile.hpp"
#include "../include/initChain.hpp"

#include "../include/getMyIp.hpp"
...
#include "../../build/generated/env.hpp"
...
void bfc::initActor()
{
	...
	if (bfc::flags::isSet("version")){
		...
		std::cout << /*bkc::*/blank::env::getVersion() << std::endl;
		bfc::exit();
		return;
	}
	if (handleKey() == false)
